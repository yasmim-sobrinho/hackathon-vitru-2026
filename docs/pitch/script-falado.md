...
> sistema de ingresso — um processo. A IA é o que faz ele rodar em escala.

**"Isso não é o que o modelo preditivo já faz?"**
> O modelo diz quem está em risco. Ele não fala com ninguém. E, no calouro, ele
